...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_google_2ftype_2flatlng_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_google_2ftype_2flatlng_2eproto = nullptr;

const uint32_t TableStruct_google_2ftype_2flatlng_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_google_2ftype_2flatlng_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_google_2ftype_2flatlng_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_google_2ftype_2flatlng_2eproto = {
    false, false, 192, descriptor_table_protodef_google_2ftype_2flatlng_2eproto,
    ...
    file_level_metadata_google_2ftype_2flatlng_2eproto, file_level_enum_descriptors_google_2ftype_2flatlng_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_google_2ftype_2flatlng_2eproto(&descriptor_table_google_2ftype_2flatlng_2eproto);
namespace google {
namespace type {
